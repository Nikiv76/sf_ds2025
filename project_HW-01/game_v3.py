...
# Ниже представлены три метода по угадыванию числа, первые два были даны
# изначально, третий метод предложен мной.

## Метод  первый: Случайное угадывание.

def random_predict(number: int = 1) -> int:
    """Угадываем на random, никак не используя информацию о больше или меньше.
